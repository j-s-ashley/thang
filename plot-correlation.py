...
plot_measurement(hbi_3pg_under, tc_cold_3pg_under, '3PG', 'under', 'HBI', 'TC_cold')
plot_measurement(hbi_3pg_away, hbi_10pg_away, 'HBI_gain', 'away', '3_point', '10_point')
plot_measurement(hbi_3pg_under, hbi_10pg_under, 'HBI_gain', 'under', '3_point', '10_point')
plot_measurement(tc_warm_3pg_away, tc_warm_10pg_away, 'TC_warm_gain', 'away', '3_point', '10_point')
plot_measurement(tc_warm_3pg_under, tc_warm_10pg_under, 'TC_warm_gain', 'under', '3_point', '10_point')
plot_measurement(tc_cold_3pg_away, tc_cold_10pg_away, 'TC_cold_gain', 'away', '3_point', '10_point')
plot_measurement(tc_cold_3pg_under, tc_cold_10pg_under, 'TC_cold_gain', 'under', '3_point', '10_point')
plot_measurement(tc_cold_3pg_away, tc_warm_3pg_away, '3PG', 'away', 'TC_cold', 'TC_warm')
plot_measurement(tc_cold_3pg_under, tc_warm_3pg_under, '3PG', 'under', 'TC_cold', 'TC_warm')
